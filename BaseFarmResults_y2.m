...
% Original results (no grain scale factor), year 2.
clear all;
...
topLevelFolder = '../TBresults_MainFarm_y2/1p0/DMRT/';
basepath = pwd;
...
% Want to get a list of directories in the results folder
% Define some top-level folder.
topLevelFolder = '../TBresults_MainFarm_y2/1p0/MEMLS/';
basepath = pwd;
...
% Want to get a list of directories in the results folder
% Define some top-level folder.
topLevelFolder = '../TBresults_MainFarm_y2/1p0/HUT/';
basepath = pwd;
...
save -v7 dmrtobs_y2.mat dmrtobs
save -v7 dmrtsortedresults_y2.mat dmrtsortedresults
save -v7 hutobs_y2.mat hutobs
save -v7 hutsortedresults_y2.mat hutsortedresults
save -v7 memlsobs_y2.mat memlsobs
save -v7 memlssortedresults_y2.mat memlssortedresults
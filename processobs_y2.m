% This script extracts the relevant observations from a general observation file
% 19H, 19V, 37H and 37V at 50 degrees incidence angle
% For the time period of interest, and calculates mean of 10am and 2pm if both available
% Year 2
...
% This was not copied into yr2 snowdata folder
cd ../snowdata_2011-2012/snowdata/observations


% get the file name:
fid = fopen('NOSREX_sodrad_tb_avgs_2012_2013.csv','rt');  % YR1 CHANGES HERE
...
M19H = [datenum(a{1},'yyyy/mm/dd HH:MM:SS') a{2}(:,35)]; % YR 1 CHANGES HERE
M19V = [datenum(a{1},'yyyy/mm/dd HH:MM:SS') a{2}(:,36)]; % YR 1 CHANGES HERE
M37H = [datenum(a{1},'yyyy/mm/dd HH:MM:SS') a{2}(:,39)]; % YR 1 CHANGES HERE
M37V = [datenum(a{1},'yyyy/mm/dd HH:MM:SS') a{2}(:,40)]; % YR 1 CHANGES HERE
M19H(M19H== 99999) = NaN;
M19V(M19V== 99999) = NaN;
M37H(M37H== 99999) = NaN;
M37V(M37V== 99999) = NaN;
...
Datestart=datenum('01102012','ddmmyyyy')+Time1;
Dateend=datenum('31052013','ddmmyyyy')+Time2;

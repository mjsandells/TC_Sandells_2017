...
% % load 2012-13 data which create Fig 5
% load('C:\Nick\Mel\Fig5_y2_new\memlssortedresults_y2.mat');
% load('C:\Nick\Mel\Fig5_y2_new\memlsobs_y2.mat');
% load('C:\Nick\Mel\Fig5_y2_new\hutsortedresults_y2.mat');
% load('C:\Nick\Mel\Fig5_y2_new\hutobs_y2.mat');
% load('C:\Nick\Mel\Fig5_y2_new\dmrtsortedresults_y2.mat');
% load('C:\Nick\Mel\Fig5_y2_new\dmrtobs_y2.mat');
%% Create a serial date from the observation file
date = int2str(memlsobs(:,1));
[a b] = size(date);
SerialDate = [];

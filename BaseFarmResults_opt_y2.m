...
% Optimal grain scale factor, year 2.
clear all;
...
topLevelFolder = '../TBresults_optimal/y2/DMRT/';
basepath = pwd;
...
% Want to get a list of directories in the results folder
% Define some top-level folder.
topLevelFolder = '../TBresults_optimal/y2/MEMLS/';
basepath = pwd;
...
% Want to get a list of directories in the results folder
% Define some top-level folder.
topLevelFolder = '../TBresults_optimal/y2/HUT/';
basepath = pwd;
...
save -v7 dmrtobs_opt_y2.mat dmrtobs
save -v7 dmrtsortedresults_opt_y2.mat dmrtsortedresults
save -v7 hutobs_opt_y2.mat hutobs
save -v7 hutsortedresults_opt_y2.mat hutsortedresults
save -v7 memlsobs_opt_y2.mat memlsobs
save -v7 memlssortedresults_opt_y2.mat memlssortedresults